function moduleProject3() {
  ...
  function buildLearnerCard(learner, languages) {
    ...
    const favLanguage = languages.find(lang => lang.id === learner.fav.Language)
  ...
  function buildFooter(footerData) {
    ...
    let addressP = document.createElement('p')
    addressP.classList.add('contact-email')
    addressP.textContent = `Email: <a href= "mailto:${footerData.contactEmail}"> ${footerData.contactEmail}</a>`
